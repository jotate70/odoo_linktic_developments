# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_qweb': [
            ...
            # EXAMPLE: Add everyithing in the folder
            'mail_custom/static/src/components/attachment_card/attachment_card_custom.xml',
            # EXAMPLE: Remove every .xml file
            ('remove', 'mail/static/src/components/attachment_card/attachment_card.xml'),
            # EXAMPLE: Add everyithing in the folder
            'mail_custom/static/src/components/attachment_image/attachment_image_custom.xml',
            # EXAMPLE: Remove every .xml file
            ('remove', 'mail/static/src/components/attachment_image/attachment_image.xml'),
            # # EXAMPLE: Add everyithing in the folder
            # 'mail_custom/static/src/components/activity/activity_custom.xml',
            # # EXAMPLE: Remove every .xml file
            # ('remove', 'mail/static/src/components/activity/activity.xml'),
        ],
